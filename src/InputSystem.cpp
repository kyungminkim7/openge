...
std::vector<std::pair<std::weak_ptr<ge::GameObject>,
                      ge::InputSystem::OnKeyEventListener>>
    onKeyPressListeners;
...
std::vector<std::pair<std::weak_ptr<ge::GameObject>,
                      ge::InputSystem::OnMouseEventListener>>
    onMouseMoveListeners;

std::vector<std::pair<std::weak_ptr<ge::GameObject>,
                      ge::InputSystem::OnMouseEventListener>>
    onMousePressListeners;

std::vector<std::pair<std::weak_ptr<ge::GameObject>,
                      ge::InputSystem::OnMouseEventListener>>
    onMouseReleaseListeners;
